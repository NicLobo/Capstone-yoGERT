...
class EpisodeGeneration():
    ...
    def createStats(self,fullpath):
        self.ping_frequency(fullpath)
        self.numberoftrips(fullpath)
        self.mode_change(fullpath)
