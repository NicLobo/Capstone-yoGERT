## @file ShortestRouteStop.py
#  @title ShortestRouteStop
...
## @brief A class representing an object that represents the shortest route for a trace's stop points. 
#  @details This representation of the shortest route will include the stop points 
#  from the start point to end point. 
class ShortestRouteStop:
    ...
    #  @param filePath string for the path to the csv file consisting of GPS Points representing of the stop points.
